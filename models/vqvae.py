...
from models.encoder_tran import Encoder
...
class VQVAE(nn.Module):
    def __init__(self, img_size=256, patch_size=16, emb_dim=[512, 256, 128], num_embeddings=128, beta=0.25,
        ...
        self.quantizer = VectorQuantizer(num_embeddings, num_embeddings, beta)
        ...
        self.decoder = Decoder(num_embeddings, num_embeddings, n_res_layers, res_h_dim)
        # self.decoder = Decoder(
        #     out_channels=1,
        #     emb_dims=[128, 256, 512, 1024],
        #     num_layers=dec_layers,
        #     num_heads=8,
        #     # patch_size=patch_size,  # ← 删除这行
        #     # img_size=img_size,      # ← 如果 img_size 也没用，建议也删掉
        # )
