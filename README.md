...
## running command
docker build -t my-vqvae-model .

docker run --gpus all -it   -v /mnt/d/Dataset_paper/normal:/app/data   -v /mnt/d/VQModelResults:/app/results   -v /mnt/d/VQVAE:/app   -p 6006:6006   my-vqvae-model
